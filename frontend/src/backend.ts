...
export class Backend implements backendInterface {
    ...
    async addToWatchlist(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addToWatchlist(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllTradeEventsSorted(): Promise<Array<TradeEvent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTradeEventsSorted();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWatchlist(arg0: string): Promise<Array<Token>> {
        if (this.processError) {
            try {
